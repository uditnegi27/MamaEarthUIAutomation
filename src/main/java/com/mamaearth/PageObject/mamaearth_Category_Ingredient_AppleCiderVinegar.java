...
public class mamaearth_Category_Ingredient_AppleCiderVinegar  extends mamaearth_utils_CategoriesFunctions {
	 ...
	 * 
	 * ***/
	public boolean verfiy_Ingredient_AppleCiderVinegar_category_page() {
