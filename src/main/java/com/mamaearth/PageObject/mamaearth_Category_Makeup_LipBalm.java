...
public class mamaearth_Category_Makeup_LipBalm extends mamaearth_Base {
	...
	public mamaearth_Category_Makeup_LipBalm() {
		PageFactory.initElements(driver, this);
	}
	
	
	/*** This function will verify Makeup LipBalm category under Makeup category page is loaded properly? Content are coming correctly? 
	...
	public boolean verfiy_Makeup_LipBalm_category_page() throws IOException {
		...
		String title = MakeupLipBalm_page_header.getText();
		if(!title.equals("Lip Balm for Men and Women")) titleFlag = false;
