...
public class mamaearth_Category_Ingredient_Bhringmla extends mamaearth_Base {
	 ...
	 * 
	 * ***/
	public boolean verfiy_Ingredient_Bhringmla_category_page() throws IOException {
